...
import { createMovieObjectFromName } from "../movieBuilder.js"; // Import the function to create movie objects
...
router.post("/gpt", async (req, res) => {
  try {
    ...
    const messages = [
      { role: "system", content: "You are a movie recommender, output only movie names seperated by commas." }, // Optional: Define system-level instructions
